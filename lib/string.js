...
var Stringy = function() {
    ...
    */
    ...
    /**
        Returns the lowerCamelCase form of a string.  Like Camelize, but does a
        str.toLowerCase() prior to camelizing so that all caps strings separated
        by hyphen/underscore will output correctly (e.g. FOO_FOO becomes fooFoo, 
        instead of fOOFOO);
        ...
        this.camelize('funny-funny-ha-ha');     // 'funnyFunnyHaHa'
        this.camelize('is Funky Teleputer');    // 'isFunkyTeleputer'
        this.camelize('WHAT_IS SO_FUNNY');      // 'whatIsSoFunny'
        ```
    
        @method camelclassify
        @param {String} str The string to camelclassify.
        @return {String} the camelized and classified string.
    */
    Stringy.prototype.camelclassify = function(str) {
        return this.camelize(str.toLowerCase());
    }
